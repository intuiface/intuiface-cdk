...
You can modify the name of the converter function,
**⚠️ Be careful when changing the name. Within an Intuiface experience, each binding converter must have a unique name**
