 ...
 *
 * All these elements extend `IntuifaceElement` and use the appropriate decorator to make them usable in the experience, such as {@link Asset | `@Asset`} or {@link Collection | `@Collection`}.
 * 
