...
/**
 * Type can be convertible by implementing this interface. A convertible type can be used as `type` of a {@link Property | `@Property`} or {@link Parameter | `@arameter`} decorators. All value will then be converted in input/output when the property or parameter is used for example by bindings.
 *
 * @group Types
 */
